...
def coffee_sleep(n=5):
    ...
    sleep = []
    for i in range(n):
        coffee.append(int(input("Enter amount of coffee you drink pre week : ")))
        sleep.append(int(input("Enter avrege sleep duration pre night : ")))
    return coffee, sleep
...
def run():
    ...
    ax4.settitle("Big battle of 2 Disney characters")
